...
![before-using-kafka-architecture](https://github.com/user-attachments/assets/63e2a390-b267-4670-8862-4ab308d1c48e)

이를 해결하기 위해 중앙 집중화된 메시지 및 데이터의 흐름을 관리하는 구조를 가져가기로 결정했고, 그 과정에서 카프카가 개발되었다.

![after-using-kafka-architecture](https://github.com/user-attachments/assets/69e18fb3-9e44-4b82-87d9-f3f2d1e9ca14)
...
![kafka-cluster-example](https://github.com/user-attachments/assets/4af95bea-f58b-4ecc-ba96-3c1163827f27)
...
![kafka-topic-partition-example](https://github.com/user-attachments/assets/60a6e607-7924-4d02-ad48-f65708674eb6)
...
![kafka-producer-consumer-example](https://github.com/user-attachments/assets/e9be8e72-977e-4fd2-983c-d4a87e9e6e8b)
...
![kafka-consumer-group-1](https://github.com/user-attachments/assets/2aff8f34-ff73-4543-8be6-68f355e8519e)

![kafka-consumer-group-2](https://github.com/user-attachments/assets/ac6deaba-1f97-459b-83be-f515a42b99e6)

4개의 파티션에 4개의 컨슈머, 즉 파티션 개수와 컨슈머 개수가 같은 경우 최대의 읽기 성능을 보인다.

![kafka-consumer-group-3](https://github.com/user-attachments/assets/126f52bb-60c0-494b-a94f-be300f0773c4)
...
![kafka-consumer-group-4](https://github.com/user-attachments/assets/adae9260-c75c-4ff0-9366-2d1e032c5b6b)
...
![kafka-replication-example](https://github.com/user-attachments/assets/9cf1fcdb-76ee-4b51-b945-3349127db260)
...
![kafka-docker-desktop](https://github.com/user-attachments/assets/4dc3e0d7-2454-4c56-9589-84abfbaa771e)
...
- `acks`
    ...
    - `acks = 0`
      ...
      ![kafka-acks-0-example](https://github.com/user-attachments/assets/6a004a84-25ec-4182-a248-dacaafdb4330)
    ...
    - `acks = 1`
      ...
      ![kafka-acks-1-example](https://github.com/user-attachments/assets/49e22629-db32-48f5-95be-76bbb94c96ea)

        - 리더 레플리카가 메시지를 기록하고, ISR 팔로워가 기록한 메시지를 잘 복제했는지 확인하지 않고 ack를 응답한다. `acks = 0` 설정에 비해 메시지 손실 가능성은 낮으나 처리량은 떨어진다.
    - `acks = all or -1`

      ![kafka-acks-all-example](https://github.com/user-attachments/assets/fbe65aa1-fc89-4f56-9381-f7f65818bc9f)
...
![kafka-ui-create-topic](https://github.com/user-attachments/assets/3e1d07d7-47a1-4166-b3ba-4d001a00fa74)
...
![kafka-apply-console](https://github.com/user-attachments/assets/8e1d09be-65b4-4f7b-86b4-7c276e207f84)

토픽의 메시지가 잘 발행되었는지 확인하기 위해 kafka-ui에 접속해 해당 토픽의 메시지를 확인한다.

![kafka-ui-topic-message](https://github.com/user-attachments/assets/19304d1c-92a4-481e-a948-ddb5d5d0111d)
...
![transactional-outbox-architecture](https://github.com/user-attachments/assets/6976215b-1962-4639-b1c1-10389511d359)
...
![outbox-architecture-fail-case-1](https://github.com/user-attachments/assets/61b82323-06e1-4716-83e1-869c6376d2e2)
...
![outbox-architecture-fail-case-2](https://github.com/user-attachments/assets/350a47b0-875c-4754-8aae-82eefbf07808)
...
![outbox-kafka-consumer-log](https://github.com/user-attachments/assets/9de7123a-de26-4c16-abc1-aec4695b0593)
