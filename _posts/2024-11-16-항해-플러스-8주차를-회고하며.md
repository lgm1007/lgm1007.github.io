---
layout:	post
title: 항해 플러스 6기 8주차를 회고하며 - 인덱스와 분산 트랜잭션
...
tags: hanghae
comments: true
description: "시나리오에서 수행하는 조회 쿼리를 수집하고 인덱스를 적용하여 성능을 개선할 쿼리가 있다면 적용하여 성능 비교 분석하기"
---
...
#### 사가 패턴 (Saga Pattern)
사가 패턴은 각 서비스의 로컬 트랜잭션을 순차적으로 처리하고, 각 로컬 트랜잭션은 DB를 업데이트한 후 다음 로컬 트랜잭션을 트리거하는 메시지나 이벤트를 게시한다. 트랜잭션의 결과에 따라 롤백이 필요한 경우 보상 트랜잭션을 진행한다.
...
![choreography-saga-pattern](https://i.imgur.com/7cgpX0M.png)
...
![orchestration-saga-pattern](https://i.imgur.com/NWBwhyo.png)
...
![hanghae-red-badge](https://github.com/user-attachments/assets/24f4d853-d761-4a13-8963-ee08fd6afc96)
![hanghae-achivement-status](https://github.com/user-attachments/assets/c2d54b82-ca85-4a66-b9e5-e3c854970d9e)
